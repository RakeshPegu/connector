...
export const createASubscription = catchAsync(async(req:Request, res:Response, next:NextFunction)=>{
    ...
    const razorpayPlanId = existingPlanDetails.razorpay_plan_id as string
    ...
    const plan_id = planId as string
    await subscriptionModel.create({
        ...
        end_at: subscription.end_at as number,
